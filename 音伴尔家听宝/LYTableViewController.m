...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"di 二层控制器";
    ...
    musicwindow.frame = CGRectMake(150, 600, 75, 75);
    musicwindow.hidden = NO;
    [musicwindow makeKeyAndVisible];
    
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"secondcell"];
}
